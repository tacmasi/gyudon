...
#全角→半角
cat ./data/detail$(head -1 date.csv).csv|sed 's/　/ /g'|sed 'y/ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ１２３４５６７８９０/ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890/' > ./data/detail.csv
##
...
echo "trans"
cat ./data/detail$todaydate.csv|sed 's/　/ /g'|sed 'y/ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ１２３４５６７８９０/ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890/'|sort -k 1,1 -t, >./data/b.tmp
